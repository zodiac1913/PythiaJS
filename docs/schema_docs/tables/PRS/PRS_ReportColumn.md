# PRS.PRS_ReportColumn

Supporting table in the PRS schema related to prs report column.

## Snapshot

- Schema: PRS
- Table: PRS_ReportColumn
...
- FK_PRS_ReportColumn_PRS_Report: PRS.PRS_Report via ReportIdentifier -> ReportIdentifier
