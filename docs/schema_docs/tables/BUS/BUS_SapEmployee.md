...
Supporting table in the BUS schema related to bus sap employee.

## Snapshot

- Schema: BUS
- Table: BUS_SapEmployee
- Priority: supporting schema
- Approximate rows: 3265950
- Primary key: SapEmployeeIdentifier
- Column count: 7
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | SapEmployeeIdentifier | bigint | NO | PK, IDENTITY |  | Primary key identifier for this record. [inferred] |
| 2 | Description | nvarchar(100) | NO |  |  | Longer descriptive text for this value. [inferred] |
| 3 | Record | varchar(max) | NO |  |  | Field on BUS.BUS_SapEmployee named Record. [inferred] |
