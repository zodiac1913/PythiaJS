# BUS.BUS_EmployeeBackup

Supporting table in the BUS schema related to bus employee backup.

## Snapshot

- Schema: BUS
- Table: BUS_EmployeeBackup
- Priority: supporting schema
- Approximate rows: 14100
...
| 8 | Prefix | nvarchar(6) | YES |  |  | Field on BUS.BUS_EmployeeBackup named Prefix. [inferred] |
| 9 | Suffix | nvarchar(16) | YES |  |  | Field on BUS.BUS_EmployeeBackup named Suffix. [inferred] |
...
| 16 | Moniker | nvarchar(150) | YES |  |  | Field on BUS.BUS_EmployeeBackup named Moniker. [inferred] |
| 17 | Echelon | nvarchar(50) | YES |  |  | Field on BUS.BUS_EmployeeBackup named Echelon. [inferred] |
...
| 20 | MailStop | nvarchar(9) | YES |  |  | Field on BUS.BUS_EmployeeBackup named MailStop. [inferred] |
| 21 | Street1 | nvarchar(40) | YES |  |  | Field on BUS.BUS_EmployeeBackup named Street1. [inferred] |
| 22 | Street2 | nvarchar(40) | YES |  |  | Field on BUS.BUS_EmployeeBackup named Street2. [inferred] |
| 23 | City | nvarchar(30) | YES |  |  | Field on BUS.BUS_EmployeeBackup named City. [inferred] |
| 24 | State | nvarchar(2) | YES |  |  | Field on BUS.BUS_EmployeeBackup named State. [inferred] |
| 25 | ZipCode | nvarchar(9) | YES |  |  | Code value used to classify or look up this record. [inferred] |
| 26 | WorkLocation | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named WorkLocation. [inferred] |
...
| 32 | Title | nvarchar(19) | YES |  |  | Field on BUS.BUS_EmployeeBackup named Title. [inferred] |
...
| 37 | ManagerTitle | nvarchar(19) | YES |  |  | Field on BUS.BUS_EmployeeBackup named ManagerTitle. [inferred] |
...
| 58 | Building | nvarchar(10) | YES |  |  | Field on BUS.BUS_EmployeeBackup named Building. [inferred] |
| 59 | SeparatedDate | datetime2(0) | YES |  |  | Date associated with this attribute or event. [inferred] |
| 60 | BaseHours | numeric(6,2) | YES |  |  | Field on BUS.BUS_EmployeeBackup named BaseHours. [inferred] |
| 61 | Salary | numeric(10,2) | YES |  |  | Field on BUS.BUS_EmployeeBackup named Salary. [inferred] |
| 62 | LocalityAdjustment | numeric(10,2) | YES |  |  | Field on BUS.BUS_EmployeeBackup named LocalityAdjustment. [inferred] |
| 63 | TotalSalary | numeric(11,2) | YES |  |  | Field on BUS.BUS_EmployeeBackup named TotalSalary. [inferred] |
...
| 72 | FullPosition | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named FullPosition. [inferred] |
| 73 | AppointmentCategory | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named AppointmentCategory. [inferred] |
...
| 78 | EuaCommunity | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named EuaCommunity. [inferred] |
| 79 | EuaRegion | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named EuaRegion. [inferred] |
| 80 | AnnuitantIndicator | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named AnnuitantIndicator. [inferred] |
...
| 90 | FunctionSensitivity | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named FunctionSensitivity. [inferred] |
| 91 | FunctionSensitivityDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 92 | Grade | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named Grade. [inferred] |
...
| 101 | JobSeries | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named JobSeries. [inferred] |
| 102 | JobSeriesDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 103 | PayBasis | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named PayBasis. [inferred] |
| 104 | PayBasisDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 105 | PayPlan | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named PayPlan. [inferred] |
...
| 110 | PayRateDeterminant | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named PayRateDeterminant. [inferred] |
| 111 | PayRateDeterminantDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 112 | ProfessionalClassification | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named ProfessionalClassification. [inferred] |
...
| 115 | PositionIndicator | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named PositionIndicator. [inferred] |
| 116 | PositionIndicatorDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 117 | PositionFill | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named PositionFill. [inferred] |
| 118 | PositionFillDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 119 | PositionOccupied | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named PositionOccupied. [inferred] |
| 120 | PositionOccupiedDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 121 | PositionSensitivity | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named PositionSensitivity. [inferred] |
...
| 125 | RaceNationalOrigin | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named RaceNationalOrigin. [inferred] |
| 126 | RaceNationalOriginDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 127 | RetirementPlan | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named RetirementPlan. [inferred] |
| 128 | RetirementPlanDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 129 | Sex | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named Sex. [inferred] |
| 130 | SexDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 131 | Smsa | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named Smsa. [inferred] |
| 132 | SmsaDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 133 | SpecialEmploymentProgram | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named SpecialEmploymentProgram. [inferred] |
| 134 | SpecialEmploymentProgramDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 135 | Step | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named Step. [inferred] |
| 136 | StepDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 137 | Tenure | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named Tenure. [inferred] |
...
| 142 | UnitedStatesCitizenship | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named UnitedStatesCitizenship. [inferred] |
| 143 | UnitedStatesCitizenshipDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 144 | VeteranPreference | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named VeteranPreference. [inferred] |
| 145 | VeteranPreferenceDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 146 | VietnamEraVeteran | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named VietnamEraVeteran. [inferred] |
...
| 149 | WorkSchedule | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeBackup named WorkSchedule. [inferred] |
...
| 153 | AddUserIdentifier | bigint | YES |  |  | Identifier that likely links this record to AddUser. [inferred] |
| 154 | AddTimeStamp | datetime2(0) | YES |  |  | Date and time associated with this attribute or event. [inferred] |
| 155 | LastUpdateUserIdentifier | bigint | YES |  |  | Identifier that likely links this record to LastUpdateUser. [inferred] |
| 156 | LastUpdateTimeStamp | datetime2(0) | YES |  |  | Date and time associated with this attribute or event. [inferred] |
