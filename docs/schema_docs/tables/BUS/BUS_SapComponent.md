# BUS.BUS_SapComponent

Supporting table in the BUS schema related to bus sap component.

## Snapshot

- Schema: BUS
- Table: BUS_SapComponent
- Priority: supporting schema
- Approximate rows: 262358
- Primary key: SapComponentIdentifier
- Column count: 7
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | SapComponentIdentifier | bigint | NO | PK, IDENTITY |  | Primary key identifier for this record. [inferred] |
| 2 | Description | nvarchar(100) | NO |  |  | Longer descriptive text for this value. [inferred] |
| 3 | Record | varchar(max) | NO |  |  | Field on BUS.BUS_SapComponent named Record. [inferred] |
