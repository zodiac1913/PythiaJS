# BUS.BUS_EmployeeTest

Supporting table in the BUS schema related to bus employee test.

## Snapshot

- Schema: BUS
- Table: BUS_EmployeeTest
...
| 9 | Prefix | nvarchar(6) | YES |  |  | Field on BUS.BUS_EmployeeTest named Prefix. [inferred] |
| 10 | Suffix | nvarchar(16) | YES |  |  | Field on BUS.BUS_EmployeeTest named Suffix. [inferred] |
...
| 17 | Moniker | nvarchar(150) | YES |  |  | Field on BUS.BUS_EmployeeTest named Moniker. [inferred] |
| 18 | Echelon | nvarchar(50) | YES |  |  | Field on BUS.BUS_EmployeeTest named Echelon. [inferred] |
...
| 21 | MailStop | nvarchar(9) | YES |  |  | Field on BUS.BUS_EmployeeTest named MailStop. [inferred] |
| 22 | Street1 | nvarchar(50) | YES |  |  | Field on BUS.BUS_EmployeeTest named Street1. [inferred] |
| 23 | Street2 | nvarchar(50) | YES |  |  | Field on BUS.BUS_EmployeeTest named Street2. [inferred] |
| 24 | City | nvarchar(50) | YES |  |  | Field on BUS.BUS_EmployeeTest named City. [inferred] |
| 25 | State | nvarchar(2) | YES |  |  | Field on BUS.BUS_EmployeeTest named State. [inferred] |
| 26 | ZipCode | nvarchar(9) | YES |  |  | Code value used to classify or look up this record. [inferred] |
| 27 | WorkLocation | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named WorkLocation. [inferred] |
...
| 33 | Title | nvarchar(32) | YES |  |  | Field on BUS.BUS_EmployeeTest named Title. [inferred] |
...
| 38 | ManagerTitle | nvarchar(32) | YES |  |  | Field on BUS.BUS_EmployeeTest named ManagerTitle. [inferred] |
...
| 59 | Building | nvarchar(10) | YES |  |  | Field on BUS.BUS_EmployeeTest named Building. [inferred] |
| 60 | SeparatedDate | datetime2(0) | YES |  |  | Date associated with this attribute or event. [inferred] |
| 61 | BaseHours | numeric(6,2) | YES |  |  | Field on BUS.BUS_EmployeeTest named BaseHours. [inferred] |
| 62 | Salary | numeric(10,2) | YES |  |  | Field on BUS.BUS_EmployeeTest named Salary. [inferred] |
| 63 | LocalityAdjustment | numeric(10,2) | YES |  |  | Field on BUS.BUS_EmployeeTest named LocalityAdjustment. [inferred] |
| 64 | TotalSalary | numeric(11,2) | YES |  |  | Field on BUS.BUS_EmployeeTest named TotalSalary. [inferred] |
...
| 73 | FullPosition | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named FullPosition. [inferred] |
| 74 | AppointmentCategory | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named AppointmentCategory. [inferred] |
...
| 79 | EuaCommunity | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named EuaCommunity. [inferred] |
| 80 | EuaRegion | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named EuaRegion. [inferred] |
| 81 | AnnuitantIndicator | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named AnnuitantIndicator. [inferred] |
...
| 91 | FunctionSensitivity | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named FunctionSensitivity. [inferred] |
| 92 | FunctionSensitivityDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 93 | Grade | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named Grade. [inferred] |
...
| 102 | JobSeries | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named JobSeries. [inferred] |
| 103 | JobSeriesDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 104 | PayBasis | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named PayBasis. [inferred] |
| 105 | PayBasisDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 106 | PayPlan | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named PayPlan. [inferred] |
...
| 111 | PayRateDeterminant | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named PayRateDeterminant. [inferred] |
| 112 | PayRateDeterminantDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 113 | ProfessionalClassification | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named ProfessionalClassification. [inferred] |
...
| 116 | PositionIndicator | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named PositionIndicator. [inferred] |
| 117 | PositionIndicatorDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 118 | PositionFill | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named PositionFill. [inferred] |
| 119 | PositionFillDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 120 | PositionOccupied | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named PositionOccupied. [inferred] |
| 121 | PositionOccupiedDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 122 | PositionSensitivity | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named PositionSensitivity. [inferred] |
...
| 126 | RaceNationalOrigin | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named RaceNationalOrigin. [inferred] |
| 127 | RaceNationalOriginDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 128 | RetirementPlan | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named RetirementPlan. [inferred] |
| 129 | RetirementPlanDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 130 | Sex | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named Sex. [inferred] |
| 131 | SexDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 132 | Smsa | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named Smsa. [inferred] |
| 133 | SmsaDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 134 | SpecialEmploymentProgram | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named SpecialEmploymentProgram. [inferred] |
| 135 | SpecialEmploymentProgramDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 136 | Step | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named Step. [inferred] |
| 137 | StepDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 138 | Tenure | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named Tenure. [inferred] |
...
| 143 | UnitedStatesCitizenship | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named UnitedStatesCitizenship. [inferred] |
| 144 | UnitedStatesCitizenshipDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 145 | VeteranPreference | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named VeteranPreference. [inferred] |
| 146 | VeteranPreferenceDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 147 | VietnamEraVeteran | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named VietnamEraVeteran. [inferred] |
...
| 150 | WorkSchedule | nvarchar(20) | YES |  |  | Field on BUS.BUS_EmployeeTest named WorkSchedule. [inferred] |
...
| 154 | AddUserIdentifier | bigint | YES |  |  | Identifier that likely links this record to AddUser. [inferred] |
| 155 | AddTimeStamp | datetime2(0) | YES |  |  | Date and time associated with this attribute or event. [inferred] |
| 156 | LastUpdateUserIdentifier | bigint | YES |  |  | Identifier that likely links this record to LastUpdateUser. [inferred] |
| 157 | LastUpdateTimeStamp | datetime2(0) | YES |  |  | Date and time associated with this attribute or event. [inferred] |
| 158 | Latitude | numeric(17,14) | YES |  |  | Field on BUS.BUS_EmployeeTest named Latitude. [inferred] |
| 159 | Longitude | numeric(17,14) | YES |  |  | Field on BUS.BUS_EmployeeTest named Longitude. [inferred] |
| 160 | BuildingIdentifier | bigint | YES |  |  | Identifier that likely links this record to Building. [inferred] |
| 161 | RadiusDistance | numeric(19,14) | YES |  |  | Field on BUS.BUS_EmployeeTest named RadiusDistance. [inferred] |
| 162 | DrivingDistance | numeric(19,14) | YES |  |  | Field on BUS.BUS_EmployeeTest named DrivingDistance. [inferred] |
| 163 | RouteSteps | nvarchar(max) | YES |  |  | Field on BUS.BUS_EmployeeTest named RouteSteps. [inferred] |
...
| 172 | AdsStreet1 | nvarchar(50) | YES |  |  | Field on BUS.BUS_EmployeeTest named AdsStreet1. [inferred] |
| 173 | AdsStreet2 | nvarchar(50) | YES |  |  | Field on BUS.BUS_EmployeeTest named AdsStreet2. [inferred] |
| 174 | AdsCity | nvarchar(50) | YES |  |  | Field on BUS.BUS_EmployeeTest named AdsCity. [inferred] |
| 175 | AdsState | nvarchar(2) | YES |  |  | Field on BUS.BUS_EmployeeTest named AdsState. [inferred] |
| 176 | AdsZipCode | nvarchar(9) | YES |  |  | Code value used to classify or look up this record. [inferred] |
| 177 | AdsLatitude | numeric(17,14) | YES |  |  | Field on BUS.BUS_EmployeeTest named AdsLatitude. [inferred] |
| 178 | AdsLongitude | numeric(17,14) | YES |  |  | Field on BUS.BUS_EmployeeTest named AdsLongitude. [inferred] |
| 179 | AdsRadiusDistance | numeric(19,14) | YES |  |  | Field on BUS.BUS_EmployeeTest named AdsRadiusDistance. [inferred] |
| 180 | AdsDrivingDistance | numeric(19,14) | YES |  |  | Field on BUS.BUS_EmployeeTest named AdsDrivingDistance. [inferred] |
| 181 | AdsRouteSteps | nvarchar(max) | YES |  |  | Field on BUS.BUS_EmployeeTest named AdsRouteSteps. [inferred] |
...
| 185 | ManagerRemoteWorkSelection | nvarchar(100) | YES |  |  | Field on BUS.BUS_EmployeeTest named ManagerRemoteWorkSelection. [inferred] |
| 186 | LocalityArea | nvarchar(100) | YES |  |  | Field on BUS.BUS_EmployeeTest named LocalityArea. [inferred] |
| 187 | LocalityAreaDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 188 | BusKey | nvarchar(10) | YES |  |  | Field on BUS.BUS_EmployeeTest named BusKey. [inferred] |
| 191 | HourlyRate | numeric(3,2) | YES |  |  | Field on BUS.BUS_EmployeeTest named HourlyRate. [inferred] |
| 192 | OvertimeRate | numeric(3,2) | YES |  |  | Field on BUS.BUS_EmployeeTest named OvertimeRate. [inferred] |
