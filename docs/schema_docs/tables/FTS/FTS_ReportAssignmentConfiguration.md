# FTS.FTS_ReportAssignmentConfiguration

Supporting table in the FTS schema related to fts report assignment configuration.

## Snapshot

- Schema: FTS
- Table: FTS_ReportAssignmentConfiguration
...
- FK_FTS_ReportAssignmentConfiguration_FTS_ReportAssignment: FTS.FTS_ReportAssignment via ReportAssignmentIdentifier -> ReportAssignmentIdentifier
