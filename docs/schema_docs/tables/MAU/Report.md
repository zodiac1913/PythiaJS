...
Supporting table in the MAU schema related to report.
...
| 4 | AppIdentifier | bigint | YES |  |  | Identifier that likely links this record to App. [inferred] |
| 5 | Alias | nvarchar(10) | YES |  |  | Field on MAU.Report named Alias. [inferred] |
| 6 | AccessModifier | nvarchar(50) | NO |  |  | Field on MAU.Report named AccessModifier. [inferred] |
...
| 11 | Data | nvarchar(max) | NO |  |  | Field on MAU.Report named Data. [inferred] |
