# ESS.ESS_EthicsLiability

Supporting table in the ESS schema related to ess ethics liability.

## Snapshot

- Schema: ESS
- Table: ESS_EthicsLiability
...
- FK__ESS_Ethic__Ethic__06B2CA91: ESS.ESS_EthicsForm via EthicsFormIdentifier -> EthicsFormIdentifier
...
| 5 | LiabilityCity | varchar(50) | YES |  |  | Field on ESS.ESS_EthicsLiability named LiabilityCity. [inferred] |
| 6 | LiabilityState | varchar(50) | YES |  |  | Field on ESS.ESS_EthicsLiability named LiabilityState. [inferred] |
...
| 15 | LiabilityComment | varchar(4000) | YES |  |  | Field on ESS.ESS_EthicsLiability named LiabilityComment. [inferred] |
