...
Business-critical table in the HR schema related to hr key value.
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | KeyValueIdentifier | bigint | NO | IDENTITY |  | Identifier that likely links this record to KeyValue. [inferred] |
