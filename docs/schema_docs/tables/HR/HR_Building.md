...
Business-critical table in the HR schema related to hr building.
...
| 3 | Street | nvarchar(40) | YES |  |  | Field on HR.HR_Building named Street. [inferred] |
| 4 | City | nvarchar(30) | YES |  |  | Field on HR.HR_Building named City. [inferred] |
| 5 | State | nvarchar(2) | YES |  |  | Field on HR.HR_Building named State. [inferred] |
| 6 | ZipCode | nvarchar(9) | YES |  |  | Code value used to classify or look up this record. [inferred] |
| 7 | BuildingLatitude | numeric(17,14) | YES |  |  | Field on HR.HR_Building named BuildingLatitude. [inferred] |
| 8 | BuildingLongitude | numeric(17,14) | YES |  |  | Field on HR.HR_Building named BuildingLongitude. [inferred] |
