# HR.HR_PersonnelActionTMP

Business-critical table in the HR schema related to hr personnel action tmp.

## Snapshot

- Schema: HR
- Table: HR_PersonnelActionTMP
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | PersonnelActionIdentifier | bigint | NO |  |  | Identifier that likely links this record to PersonnelAction. [inferred] |
...
| 7 | Noa | nvarchar(255) | YES |  |  | Field on HR.HR_PersonnelActionTMP named Noa. [inferred] |
| 8 | NoaDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 9 | PersonnelActionSubmissionDate | datetime2(0) | YES |  |  | Date associated with this attribute or event. [inferred] |
| 10 | PersonnelActionEffectiveDate | datetime2(0) | YES |  |  | Date associated with this attribute or event. [inferred] |
| 11 | PersonnelActionFiscalYear | nvarchar(4) | YES |  |  | Field on HR.HR_PersonnelActionTMP named PersonnelActionFiscalYear. [inferred] |
| 12 | LegalAuthority1 | nvarchar(255) | YES |  |  | Field on HR.HR_PersonnelActionTMP named LegalAuthority1. [inferred] |
| 13 | LegalAuthorityDescription1 | nvarchar(255) | YES |  |  | Field on HR.HR_PersonnelActionTMP named LegalAuthorityDescription1. [inferred] |
| 14 | LegalAuthority2 | nvarchar(255) | YES |  |  | Field on HR.HR_PersonnelActionTMP named LegalAuthority2. [inferred] |
| 15 | LegalAuthorityDescription2 | nvarchar(255) | YES |  |  | Field on HR.HR_PersonnelActionTMP named LegalAuthorityDescription2. [inferred] |
| 16 | AwardCategory | nvarchar(255) | YES |  |  | Field on HR.HR_PersonnelActionTMP named AwardCategory. [inferred] |
| 17 | AwardAmount | numeric(10,2) | YES |  |  | Field on HR.HR_PersonnelActionTMP named AwardAmount. [inferred] |
| 18 | AwardTimeOffHourQuantity | numeric(6,2) | YES |  |  | Field on HR.HR_PersonnelActionTMP named AwardTimeOffHourQuantity. [inferred] |
| 19 | GainAgency | nvarchar(255) | YES |  |  | Field on HR.HR_PersonnelActionTMP named GainAgency. [inferred] |
| 20 | GainAgencyDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 21 | LossAgency | nvarchar(255) | YES |  |  | Field on HR.HR_PersonnelActionTMP named LossAgency. [inferred] |
...
| 25 | AcademicDiscipline | nvarchar(255) | YES |  |  | Field on HR.HR_PersonnelActionTMP named AcademicDiscipline. [inferred] |
| 26 | AcademicDisciplineDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 27 | InstructionalProgram | nvarchar(255) | YES |  |  | Field on HR.HR_PersonnelActionTMP named InstructionalProgram. [inferred] |
...
| 30 | Prefix | nvarchar(6) | YES |  |  | Field on HR.HR_PersonnelActionTMP named Prefix. [inferred] |
| 31 | Suffix | nvarchar(16) | YES |  |  | Field on HR.HR_PersonnelActionTMP named Suffix. [inferred] |
| 32 | SocialSecurityNumber | nvarchar(9) | YES |  |  | Number used to identify or track this record. [inferred] |
| 33 | MailStop | nvarchar(9) | YES |  |  | Field on HR.HR_PersonnelActionTMP named MailStop. [inferred] |
| 34 | State | nvarchar(2) | YES |  |  | Field on HR.HR_PersonnelActionTMP named State. [inferred] |
| 35 | Title | nvarchar(32) | YES |  |  | Field on HR.HR_PersonnelActionTMP named Title. [inferred] |
...
| 42 | Building | nvarchar(10) | YES |  |  | Field on HR.HR_PersonnelActionTMP named Building. [inferred] |
| 43 | BaseHours | numeric(6,2) | YES |  |  | Field on HR.HR_PersonnelActionTMP named BaseHours. [inferred] |
| 44 | Salary | numeric(10,2) | YES |  |  | Field on HR.HR_PersonnelActionTMP named Salary. [inferred] |
| 45 | LocalityAdjustment | numeric(10,2) | YES |  |  | Field on HR.HR_PersonnelActionTMP named LocalityAdjustment. [inferred] |
...
| 48 | AppointmentCategory | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named AppointmentCategory. [inferred] |
| 49 | AppointmentCategoryDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 50 | AnnuitantIndicator | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named AnnuitantIndicator. [inferred] |
...
| 60 | FunctionSensitivity | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named FunctionSensitivity. [inferred] |
| 61 | FunctionSensitivityDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 62 | Grade | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named Grade. [inferred] |
...
| 71 | JobSeries | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named JobSeries. [inferred] |
| 72 | JobSeriesDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 73 | PayBasis | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named PayBasis. [inferred] |
| 74 | PayBasisDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 75 | PayPlan | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named PayPlan. [inferred] |
...
| 80 | PayRateDeterminant | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named PayRateDeterminant. [inferred] |
| 81 | PayRateDeterminantDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 82 | ProfessionalClassification | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named ProfessionalClassification. [inferred] |
...
| 85 | PositionIndicator | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named PositionIndicator. [inferred] |
| 86 | PositionIndicatorDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 87 | PositionFill | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named PositionFill. [inferred] |
| 88 | PositionFillDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 89 | PositionOccupied | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named PositionOccupied. [inferred] |
| 90 | PositionOccupiedDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 91 | PositionSensitivity | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named PositionSensitivity. [inferred] |
...
| 95 | RaceNationalOrigin | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named RaceNationalOrigin. [inferred] |
| 96 | RaceNationalOriginDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 97 | RetirementPlan | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named RetirementPlan. [inferred] |
| 98 | RetirementPlanDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 99 | Sex | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named Sex. [inferred] |
| 100 | SexDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 101 | Smsa | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named Smsa. [inferred] |
| 102 | SmsaDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 103 | SpecialEmploymentProgram | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named SpecialEmploymentProgram. [inferred] |
| 104 | SpecialEmploymentProgramDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 105 | StatutoryCeiling | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named StatutoryCeiling. [inferred] |
| 106 | StatutoryCeilingDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 107 | Step | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named Step. [inferred] |
| 108 | StepDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 109 | Tenure | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named Tenure. [inferred] |
...
| 113 | UnitedStatesCitizenship | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named UnitedStatesCitizenship. [inferred] |
| 114 | UnitedStatesCitizenshipDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 115 | VeteranPreference | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named VeteranPreference. [inferred] |
| 116 | VeteranPreferenceDescription | nvarchar(255) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 117 | VietnamEraVeteran | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named VietnamEraVeteran. [inferred] |
...
| 120 | WorkSchedule | nvarchar(20) | YES |  |  | Field on HR.HR_PersonnelActionTMP named WorkSchedule. [inferred] |
...
| 127 | NoaSuffix | nvarchar(1) | YES |  |  | Field on HR.HR_PersonnelActionTMP named NoaSuffix. [inferred] |
...
| 130 | OriginalNoa | nvarchar(3) | YES |  |  | Field on HR.HR_PersonnelActionTMP named OriginalNoa. [inferred] |
| 131 | OriginalNoaSuffix | nvarchar(1) | YES |  |  | Field on HR.HR_PersonnelActionTMP named OriginalNoaSuffix. [inferred] |
| 132 | OriginalPersonnelActionEffectiveDate | datetime2(7) | YES |  |  | Date associated with this attribute or event. [inferred] |
| 133 | OriginalLegalAuthority1 | nvarchar(255) | YES |  |  | Field on HR.HR_PersonnelActionTMP named OriginalLegalAuthority1. [inferred] |
| 134 | OriginalLegalAuthorityDescription1 | nvarchar(255) | YES |  |  | Field on HR.HR_PersonnelActionTMP named OriginalLegalAuthorityDescription1. [inferred] |
| 135 | OriginalLegalAuthority2 | nvarchar(255) | YES |  |  | Field on HR.HR_PersonnelActionTMP named OriginalLegalAuthority2. [inferred] |
| 136 | OriginalLegalAuthorityDescription2 | nvarchar(255) | YES |  |  | Field on HR.HR_PersonnelActionTMP named OriginalLegalAuthorityDescription2. [inferred] |
| 137 | OriginalEffectiveSequence | int | YES |  |  | Numeric value associated with this record. [inferred] |
| 138 | BusKey | nvarchar(10) | YES |  |  | Field on HR.HR_PersonnelActionTMP named BusKey. [inferred] |
| 139 | WipStatus | nvarchar(3) | YES |  |  | Status value describing the current state of the record. [inferred] |
| 140 | EmployeeRecordNumber | int | YES |  |  | Number used to identify or track this record. [inferred] |
| 141 | EmployeeHistoryIdentifier | bigint | YES |  |  | Identifier that likely links this record to EmployeeHistory. [inferred] |
| 142 | AwardCategoryDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 143 | ProcessedDate | datetime2(0) | YES |  |  | Date associated with this attribute or event. [inferred] |
