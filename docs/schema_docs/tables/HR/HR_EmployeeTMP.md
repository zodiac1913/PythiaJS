...
Business-critical table in the HR schema related to hr employee tmp.

## Snapshot

- Schema: HR
- Table: HR_EmployeeTMP
...
| 8 | Prefix | nvarchar(6) | YES |  |  | Field on HR.HR_EmployeeTMP named Prefix. [inferred] |
| 9 | Suffix | nvarchar(16) | YES |  |  | Field on HR.HR_EmployeeTMP named Suffix. [inferred] |
...
| 16 | Moniker | nvarchar(150) | YES |  |  | Field on HR.HR_EmployeeTMP named Moniker. [inferred] |
| 17 | Echelon | nvarchar(50) | YES |  |  | Field on HR.HR_EmployeeTMP named Echelon. [inferred] |
...
| 20 | MailStop | nvarchar(9) | YES |  |  | Field on HR.HR_EmployeeTMP named MailStop. [inferred] |
| 21 | Street1 | nvarchar(40) | YES |  |  | Field on HR.HR_EmployeeTMP named Street1. [inferred] |
| 22 | Street2 | nvarchar(40) | YES |  |  | Field on HR.HR_EmployeeTMP named Street2. [inferred] |
| 23 | City | nvarchar(30) | YES |  |  | Field on HR.HR_EmployeeTMP named City. [inferred] |
| 24 | State | nvarchar(2) | YES |  |  | Field on HR.HR_EmployeeTMP named State. [inferred] |
| 25 | ZipCode | nvarchar(9) | YES |  |  | Code value used to classify or look up this record. [inferred] |
| 26 | WorkLocation | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named WorkLocation. [inferred] |
...
| 32 | Title | nvarchar(32) | YES |  |  | Field on HR.HR_EmployeeTMP named Title. [inferred] |
...
| 37 | ManagerTitle | nvarchar(32) | YES |  |  | Field on HR.HR_EmployeeTMP named ManagerTitle. [inferred] |
...
| 58 | Building | nvarchar(10) | YES |  |  | Field on HR.HR_EmployeeTMP named Building. [inferred] |
| 59 | SeparatedDate | datetime2(0) | YES |  |  | Date associated with this attribute or event. [inferred] |
| 60 | BaseHours | numeric(6,2) | YES |  |  | Field on HR.HR_EmployeeTMP named BaseHours. [inferred] |
| 61 | Salary | numeric(10,2) | YES |  |  | Field on HR.HR_EmployeeTMP named Salary. [inferred] |
| 62 | LocalityAdjustment | numeric(10,2) | YES |  |  | Field on HR.HR_EmployeeTMP named LocalityAdjustment. [inferred] |
| 63 | TotalSalary | numeric(11,2) | YES |  |  | Field on HR.HR_EmployeeTMP named TotalSalary. [inferred] |
...
| 72 | FullPosition | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named FullPosition. [inferred] |
| 73 | AppointmentCategory | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named AppointmentCategory. [inferred] |
...
| 78 | EuaCommunity | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named EuaCommunity. [inferred] |
| 79 | EuaRegion | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named EuaRegion. [inferred] |
| 80 | AnnuitantIndicator | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named AnnuitantIndicator. [inferred] |
...
| 90 | FunctionSensitivity | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named FunctionSensitivity. [inferred] |
| 91 | FunctionSensitivityDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 92 | Grade | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named Grade. [inferred] |
...
| 101 | JobSeries | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named JobSeries. [inferred] |
| 102 | JobSeriesDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 103 | PayBasis | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named PayBasis. [inferred] |
| 104 | PayBasisDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 105 | PayPlan | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named PayPlan. [inferred] |
...
| 110 | PayRateDeterminant | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named PayRateDeterminant. [inferred] |
| 111 | PayRateDeterminantDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 112 | ProfessionalClassification | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named ProfessionalClassification. [inferred] |
...
| 115 | PositionIndicator | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named PositionIndicator. [inferred] |
| 116 | PositionIndicatorDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 117 | PositionFill | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named PositionFill. [inferred] |
| 118 | PositionFillDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 119 | PositionOccupied | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named PositionOccupied. [inferred] |
| 120 | PositionOccupiedDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 121 | PositionSensitivity | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named PositionSensitivity. [inferred] |
...
| 125 | RaceNationalOrigin | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named RaceNationalOrigin. [inferred] |
| 126 | RaceNationalOriginDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 127 | RetirementPlan | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named RetirementPlan. [inferred] |
| 128 | RetirementPlanDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 129 | Sex | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named Sex. [inferred] |
| 130 | SexDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 131 | Smsa | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named Smsa. [inferred] |
| 132 | SmsaDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 133 | SpecialEmploymentProgram | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named SpecialEmploymentProgram. [inferred] |
| 134 | SpecialEmploymentProgramDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 135 | Step | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named Step. [inferred] |
| 136 | StepDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 137 | Tenure | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named Tenure. [inferred] |
...
| 142 | UnitedStatesCitizenship | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named UnitedStatesCitizenship. [inferred] |
| 143 | UnitedStatesCitizenshipDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 144 | VeteranPreference | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named VeteranPreference. [inferred] |
| 145 | VeteranPreferenceDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 146 | VietnamEraVeteran | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named VietnamEraVeteran. [inferred] |
...
| 149 | WorkSchedule | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeTMP named WorkSchedule. [inferred] |
...
| 157 | Latitude | numeric(17,14) | YES |  |  | Field on HR.HR_EmployeeTMP named Latitude. [inferred] |
| 158 | Longitude | numeric(17,14) | YES |  |  | Field on HR.HR_EmployeeTMP named Longitude. [inferred] |
| 159 | BuildingIdentifier | bigint | YES |  |  | Identifier that likely links this record to Building. [inferred] |
| 160 | RadiusDistance | numeric(19,14) | YES |  |  | Field on HR.HR_EmployeeTMP named RadiusDistance. [inferred] |
| 161 | DrivingDistance | numeric(19,14) | YES |  |  | Field on HR.HR_EmployeeTMP named DrivingDistance. [inferred] |
| 162 | RouteSteps | nvarchar(max) | YES |  |  | Field on HR.HR_EmployeeTMP named RouteSteps. [inferred] |
...
| 171 | AdsStreet1 | nvarchar(50) | YES |  |  | Field on HR.HR_EmployeeTMP named AdsStreet1. [inferred] |
| 172 | AdsStreet2 | nvarchar(50) | YES |  |  | Field on HR.HR_EmployeeTMP named AdsStreet2. [inferred] |
| 173 | AdsCity | nvarchar(50) | YES |  |  | Field on HR.HR_EmployeeTMP named AdsCity. [inferred] |
| 174 | AdsState | nvarchar(2) | YES |  |  | Field on HR.HR_EmployeeTMP named AdsState. [inferred] |
| 175 | AdsZipCode | nvarchar(9) | YES |  |  | Code value used to classify or look up this record. [inferred] |
| 176 | AdsLatitude | numeric(17,14) | YES |  |  | Field on HR.HR_EmployeeTMP named AdsLatitude. [inferred] |
| 177 | AdsLongitude | numeric(17,14) | YES |  |  | Field on HR.HR_EmployeeTMP named AdsLongitude. [inferred] |
| 178 | AdsRadiusDistance | numeric(19,14) | YES |  |  | Field on HR.HR_EmployeeTMP named AdsRadiusDistance. [inferred] |
| 179 | AdsDrivingDistance | numeric(19,14) | YES |  |  | Field on HR.HR_EmployeeTMP named AdsDrivingDistance. [inferred] |
| 180 | AdsRouteSteps | nvarchar(max) | YES |  |  | Field on HR.HR_EmployeeTMP named AdsRouteSteps. [inferred] |
...
| 184 | EmployeeRemoteWorkSelection | nvarchar(100) | YES |  |  | Field on HR.HR_EmployeeTMP named EmployeeRemoteWorkSelection. [inferred] |
| 185 | LocalityArea | nvarchar(100) | YES |  |  | Field on HR.HR_EmployeeTMP named LocalityArea. [inferred] |
| 186 | LocalityAreaDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 187 | BusKey | nvarchar(10) | YES |  |  | Field on HR.HR_EmployeeTMP named BusKey. [inferred] |
| 188 | HourlyRate | numeric(5,2) | YES |  |  | Field on HR.HR_EmployeeTMP named HourlyRate. [inferred] |
| 189 | OvertimeRate | numeric(5,2) | YES |  |  | Field on HR.HR_EmployeeTMP named OvertimeRate. [inferred] |
| 190 | RemoteTeleworkAgreementType | nvarchar(20) | YES |  |  | Type or category used to classify the record. [inferred] |
| 191 | RemoteTeleworkAgreementTypeDescription | nvarchar(150) | YES |  |  | Type or category used to classify the record. [inferred] |
