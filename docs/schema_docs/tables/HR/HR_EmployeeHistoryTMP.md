# HR.HR_EmployeeHistoryTMP

Business-critical table in the HR schema related to hr employee history tmp.

## Snapshot

- Schema: HR
- Table: HR_EmployeeHistoryTMP
...
| 9 | Prefix | nvarchar(6) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named Prefix. [inferred] |
| 10 | Suffix | nvarchar(16) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named Suffix. [inferred] |
...
| 17 | Moniker | nvarchar(150) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named Moniker. [inferred] |
| 18 | Echelon | nvarchar(50) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named Echelon. [inferred] |
...
| 21 | MailStop | nvarchar(9) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named MailStop. [inferred] |
| 22 | Street1 | nvarchar(40) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named Street1. [inferred] |
| 23 | Street2 | nvarchar(40) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named Street2. [inferred] |
| 24 | City | nvarchar(30) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named City. [inferred] |
| 25 | State | nvarchar(2) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named State. [inferred] |
| 26 | ZipCode | nvarchar(9) | YES |  |  | Code value used to classify or look up this record. [inferred] |
| 27 | WorkLocation | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named WorkLocation. [inferred] |
...
| 33 | Title | nvarchar(32) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named Title. [inferred] |
...
| 38 | ManagerTitle | nvarchar(32) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named ManagerTitle. [inferred] |
...
| 59 | Building | nvarchar(10) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named Building. [inferred] |
| 60 | SeparatedDate | datetime | YES |  |  | Date associated with this attribute or event. [inferred] |
| 61 | BaseHours | numeric(6,2) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named BaseHours. [inferred] |
| 62 | Salary | numeric(10,2) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named Salary. [inferred] |
| 63 | LocalityAdjustment | numeric(10,2) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named LocalityAdjustment. [inferred] |
| 64 | TotalSalary | numeric(11,2) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named TotalSalary. [inferred] |
...
| 73 | FullPosition | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named FullPosition. [inferred] |
| 74 | AppointmentCategory | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named AppointmentCategory. [inferred] |
...
| 79 | EuaCommunity | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named EuaCommunity. [inferred] |
| 80 | EuaRegion | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named EuaRegion. [inferred] |
| 81 | AnnuitantIndicator | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named AnnuitantIndicator. [inferred] |
...
| 91 | FunctionSensitivity | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named FunctionSensitivity. [inferred] |
| 92 | FunctionSensitivityDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 93 | Grade | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named Grade. [inferred] |
...
| 102 | JobSeries | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named JobSeries. [inferred] |
| 103 | JobSeriesDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 104 | PayBasis | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named PayBasis. [inferred] |
| 105 | PayBasisDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 106 | PayPlan | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named PayPlan. [inferred] |
...
| 111 | PayRateDeterminant | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named PayRateDeterminant. [inferred] |
| 112 | PayRateDeterminantDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 113 | ProfessionalClassification | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named ProfessionalClassification. [inferred] |
...
| 116 | PositionIndicator | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named PositionIndicator. [inferred] |
| 117 | PositionIndicatorDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 118 | PositionFill | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named PositionFill. [inferred] |
| 119 | PositionFillDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 120 | PositionOccupied | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named PositionOccupied. [inferred] |
| 121 | PositionOccupiedDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 122 | PositionSensitivity | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named PositionSensitivity. [inferred] |
...
| 126 | RaceNationalOrigin | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named RaceNationalOrigin. [inferred] |
| 127 | RaceNationalOriginDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 128 | RetirementPlan | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named RetirementPlan. [inferred] |
| 129 | RetirementPlanDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 130 | Sex | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named Sex. [inferred] |
| 131 | SexDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 132 | Smsa | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named Smsa. [inferred] |
| 133 | SmsaDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 134 | SpecialEmploymentProgram | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named SpecialEmploymentProgram. [inferred] |
| 135 | SpecialEmploymentProgramDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 136 | Step | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named Step. [inferred] |
| 137 | StepDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 138 | Tenure | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named Tenure. [inferred] |
...
| 143 | UnitedStatesCitizenship | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named UnitedStatesCitizenship. [inferred] |
| 144 | UnitedStatesCitizenshipDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 145 | VeteranPreference | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named VeteranPreference. [inferred] |
| 146 | VeteranPreferenceDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 147 | VietnamEraVeteran | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named VietnamEraVeteran. [inferred] |
...
| 150 | WorkSchedule | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named WorkSchedule. [inferred] |
...
| 158 | Latitude | numeric(17,14) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named Latitude. [inferred] |
| 159 | Longitude | numeric(17,14) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named Longitude. [inferred] |
| 160 | BuildingIdentifier | bigint | YES |  |  | Identifier that likely links this record to Building. [inferred] |
| 161 | RadiusDistance | numeric(19,14) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named RadiusDistance. [inferred] |
| 162 | DrivingDistance | numeric(19,14) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named DrivingDistance. [inferred] |
| 163 | RouteSteps | nvarchar(max) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named RouteSteps. [inferred] |
...
| 172 | AdsStreet1 | nvarchar(50) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named AdsStreet1. [inferred] |
| 173 | AdsStreet2 | nvarchar(50) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named AdsStreet2. [inferred] |
| 174 | AdsCity | nvarchar(50) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named AdsCity. [inferred] |
| 175 | AdsState | nvarchar(2) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named AdsState. [inferred] |
| 176 | AdsZipCode | nvarchar(9) | YES |  |  | Code value used to classify or look up this record. [inferred] |
| 177 | AdsLatitude | numeric(17,14) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named AdsLatitude. [inferred] |
| 178 | AdsLongitude | numeric(17,14) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named AdsLongitude. [inferred] |
| 179 | AdsRadiusDistance | numeric(19,14) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named AdsRadiusDistance. [inferred] |
| 180 | AdsDrivingDistance | numeric(19,14) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named AdsDrivingDistance. [inferred] |
| 181 | AdsRouteSteps | nvarchar(max) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named AdsRouteSteps. [inferred] |
...
| 185 | EmployeeRemoteWorkSelection | nvarchar(100) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named EmployeeRemoteWorkSelection. [inferred] |
| 186 | LocalityArea | nvarchar(100) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named LocalityArea. [inferred] |
| 187 | LocalityAreaDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 188 | BusKey | nvarchar(10) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named BusKey. [inferred] |
| 189 | HourlyRate | numeric(5,2) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named HourlyRate. [inferred] |
| 190 | OvertimeRate | numeric(5,2) | YES |  |  | Field on HR.HR_EmployeeHistoryTMP named OvertimeRate. [inferred] |
| 191 | RemoteTeleworkAgreementType | nvarchar(20) | YES |  |  | Type or category used to classify the record. [inferred] |
| 192 | RemoteTeleworkAgreementTypeDescription | nvarchar(150) | YES |  |  | Type or category used to classify the record. [inferred] |
