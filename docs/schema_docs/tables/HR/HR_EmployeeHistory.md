# HR.HR_EmployeeHistory

Historical employee snapshot table used to answer time-based questions about prior employee state, organization placement, and related attributes.
...
- Approximate rows: 3429249
- Primary key: not declared
- Column count: 192

## Usage Notes

- Historical version of employee records and one of the first places to look when the question is time-based.
- Use this when you need prior values for component placement, supervisor, title, status, or other employee attributes over time.
- Do not confuse this table with employee action tracking. It is a historical employee snapshot surface, not necessarily the authoritative action record.
- A common pattern is to resolve the current employee in HR.HR_Employee first, then pivot here for historical context on the same EmployeeIdentifier.

## Outbound Foreign Keys

- FK_HR_EmployeeHistory_HR_Employee: HR.HR_Employee via EmployeeIdentifier -> EmployeeIdentifier

## Columns

| # | Column | Type | Null | Key | Default | Description |
| --- | --- | --- | --- | --- | --- | --- |
| 1 | EmployeeHistoryIdentifier | bigint | NO |  |  | Identifier that likely links this record to EmployeeHistory. [inferred] |
| 2 | EmployeeIdentifier | bigint | NO |  |  | Employee key used to connect historical snapshots back to the current employee record. [inferred] |
...
| 5 | UserIdentifier | bigint | YES |  |  | User account bridge carried on the historical employee snapshot when present. [inferred] |
...
| 9 | Prefix | nvarchar(6) | YES |  |  | Field on HR.HR_EmployeeHistory named Prefix. [inferred] |
| 10 | Suffix | nvarchar(16) | YES |  |  | Field on HR.HR_EmployeeHistory named Suffix. [inferred] |
...
| 17 | Moniker | nvarchar(150) | YES |  |  | Field on HR.HR_EmployeeHistory named Moniker. [inferred] |
| 18 | Echelon | nvarchar(50) | YES |  |  | Field on HR.HR_EmployeeHistory named Echelon. [inferred] |
...
| 21 | MailStop | nvarchar(9) | YES |  |  | Field on HR.HR_EmployeeHistory named MailStop. [inferred] |
| 22 | Street1 | nvarchar(50) | YES |  |  | Field on HR.HR_EmployeeHistory named Street1. [inferred] |
| 23 | Street2 | nvarchar(50) | YES |  |  | Field on HR.HR_EmployeeHistory named Street2. [inferred] |
| 24 | City | nvarchar(50) | YES |  |  | Field on HR.HR_EmployeeHistory named City. [inferred] |
| 25 | State | nvarchar(2) | YES |  |  | Field on HR.HR_EmployeeHistory named State. [inferred] |
| 26 | ZipCode | nvarchar(9) | YES |  |  | Code value used to classify or look up this record. [inferred] |
| 27 | WorkLocation | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named WorkLocation. [inferred] |
...
| 33 | Title | nvarchar(32) | YES |  |  | Field on HR.HR_EmployeeHistory named Title. [inferred] |
...
| 38 | ManagerTitle | nvarchar(32) | YES |  |  | Field on HR.HR_EmployeeHistory named ManagerTitle. [inferred] |
...
| 59 | Building | nvarchar(10) | YES |  |  | Field on HR.HR_EmployeeHistory named Building. [inferred] |
| 60 | SeparatedDate | datetime | YES |  |  | Date associated with this attribute or event. [inferred] |
| 61 | BaseHours | numeric(6,2) | YES |  |  | Field on HR.HR_EmployeeHistory named BaseHours. [inferred] |
| 62 | Salary | numeric(10,2) | YES |  |  | Field on HR.HR_EmployeeHistory named Salary. [inferred] |
| 63 | LocalityAdjustment | numeric(10,2) | YES |  |  | Field on HR.HR_EmployeeHistory named LocalityAdjustment. [inferred] |
| 64 | TotalSalary | numeric(11,2) | YES |  |  | Field on HR.HR_EmployeeHistory named TotalSalary. [inferred] |
...
| 73 | FullPosition | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named FullPosition. [inferred] |
| 74 | AppointmentCategory | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named AppointmentCategory. [inferred] |
...
| 79 | EuaCommunity | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named EuaCommunity. [inferred] |
| 80 | EuaRegion | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named EuaRegion. [inferred] |
| 81 | AnnuitantIndicator | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named AnnuitantIndicator. [inferred] |
...
| 91 | FunctionSensitivity | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named FunctionSensitivity. [inferred] |
| 92 | FunctionSensitivityDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 93 | Grade | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named Grade. [inferred] |
...
| 102 | JobSeries | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named JobSeries. [inferred] |
| 103 | JobSeriesDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 104 | PayBasis | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named PayBasis. [inferred] |
| 105 | PayBasisDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 106 | PayPlan | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named PayPlan. [inferred] |
...
| 111 | PayRateDeterminant | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named PayRateDeterminant. [inferred] |
| 112 | PayRateDeterminantDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 113 | ProfessionalClassification | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named ProfessionalClassification. [inferred] |
...
| 116 | PositionIndicator | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named PositionIndicator. [inferred] |
| 117 | PositionIndicatorDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 118 | PositionFill | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named PositionFill. [inferred] |
| 119 | PositionFillDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 120 | PositionOccupied | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named PositionOccupied. [inferred] |
| 121 | PositionOccupiedDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 122 | PositionSensitivity | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named PositionSensitivity. [inferred] |
...
| 126 | RaceNationalOrigin | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named RaceNationalOrigin. [inferred] |
| 127 | RaceNationalOriginDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 128 | RetirementPlan | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named RetirementPlan. [inferred] |
| 129 | RetirementPlanDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 130 | Sex | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named Sex. [inferred] |
| 131 | SexDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 132 | Smsa | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named Smsa. [inferred] |
| 133 | SmsaDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 134 | SpecialEmploymentProgram | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named SpecialEmploymentProgram. [inferred] |
| 135 | SpecialEmploymentProgramDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 136 | Step | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named Step. [inferred] |
| 137 | StepDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 138 | Tenure | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named Tenure. [inferred] |
...
| 143 | UnitedStatesCitizenship | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named UnitedStatesCitizenship. [inferred] |
| 144 | UnitedStatesCitizenshipDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 145 | VeteranPreference | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named VeteranPreference. [inferred] |
| 146 | VeteranPreferenceDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 147 | VietnamEraVeteran | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named VietnamEraVeteran. [inferred] |
...
| 150 | WorkSchedule | nvarchar(20) | YES |  |  | Field on HR.HR_EmployeeHistory named WorkSchedule. [inferred] |
...
| 158 | Latitude | numeric(17,14) | YES |  |  | Field on HR.HR_EmployeeHistory named Latitude. [inferred] |
| 159 | Longitude | numeric(17,14) | YES |  |  | Field on HR.HR_EmployeeHistory named Longitude. [inferred] |
| 160 | BuildingIdentifier | bigint | YES |  |  | Identifier that likely links this record to Building. [inferred] |
| 161 | RadiusDistance | numeric(19,14) | YES |  |  | Field on HR.HR_EmployeeHistory named RadiusDistance. [inferred] |
| 162 | DrivingDistance | numeric(19,14) | YES |  |  | Field on HR.HR_EmployeeHistory named DrivingDistance. [inferred] |
| 163 | RouteSteps | nvarchar(max) | YES |  |  | Field on HR.HR_EmployeeHistory named RouteSteps. [inferred] |
...
| 172 | AdsStreet1 | nvarchar(50) | YES |  |  | Field on HR.HR_EmployeeHistory named AdsStreet1. [inferred] |
| 173 | AdsStreet2 | nvarchar(50) | YES |  |  | Field on HR.HR_EmployeeHistory named AdsStreet2. [inferred] |
| 174 | AdsCity | nvarchar(50) | YES |  |  | Field on HR.HR_EmployeeHistory named AdsCity. [inferred] |
| 175 | AdsState | nvarchar(2) | YES |  |  | Field on HR.HR_EmployeeHistory named AdsState. [inferred] |
| 176 | AdsZipCode | nvarchar(9) | YES |  |  | Code value used to classify or look up this record. [inferred] |
| 177 | AdsLatitude | numeric(17,14) | YES |  |  | Field on HR.HR_EmployeeHistory named AdsLatitude. [inferred] |
| 178 | AdsLongitude | numeric(17,14) | YES |  |  | Field on HR.HR_EmployeeHistory named AdsLongitude. [inferred] |
| 179 | AdsRadiusDistance | numeric(19,14) | YES |  |  | Field on HR.HR_EmployeeHistory named AdsRadiusDistance. [inferred] |
| 180 | AdsDrivingDistance | numeric(19,14) | YES |  |  | Field on HR.HR_EmployeeHistory named AdsDrivingDistance. [inferred] |
| 181 | AdsRouteSteps | nvarchar(max) | YES |  |  | Field on HR.HR_EmployeeHistory named AdsRouteSteps. [inferred] |
...
| 185 | EmployeeRemoteWorkSelection | nvarchar(100) | YES |  |  | Field on HR.HR_EmployeeHistory named EmployeeRemoteWorkSelection. [inferred] |
| 186 | LocalityArea | nvarchar(100) | YES |  |  | Field on HR.HR_EmployeeHistory named LocalityArea. [inferred] |
| 187 | LocalityAreaDescription | nvarchar(150) | YES |  |  | Longer descriptive text for this value. [inferred] |
| 188 | BusKey | nvarchar(10) | YES |  |  | Field on HR.HR_EmployeeHistory named BusKey. [inferred] |
| 191 | HourlyRate | numeric(5,2) | YES |  |  | Field on HR.HR_EmployeeHistory named HourlyRate. [inferred] |
| 192 | OvertimeRate | numeric(5,2) | YES |  |  | Field on HR.HR_EmployeeHistory named OvertimeRate. [inferred] |
